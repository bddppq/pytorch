...
def gradcheck(func, inputs, eps=1e-6, atol=1e-5, rtol=1e-3, raise_exception=True, check_sparse_nnz=False, nondet_tol=1e-13, nondet_rtol=1e-13):
    ...
    for i, o in enumerate(output):
        ...
        analytical, reentrant, correct_grad_sizes = get_analytical_jacobian(tupled_inputs, o, nondet_tol=nondet_tol, nondet_rtol=nondet_rtol)
        numerical = get_numerical_jacobian(fn, tupled_inputs, eps=eps)
